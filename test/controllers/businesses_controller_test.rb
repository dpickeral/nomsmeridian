...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { coordinate: @business.coordinate, name: @business.name, rating: @business.rating, url: @business.url }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { coordinate: @business.coordinate, name: @business.name, rating: @business.rating, url: @business.url }
    assert_redirected_to business_path(assigns(:business))
  end

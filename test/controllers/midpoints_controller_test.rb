...
class MidpointsControllerTest < ActionController::TestCase
  ...
  test "should create midpoint" do
    assert_difference('Midpoint.count') do
      post :create, midpoint: { address_1: @midpoint.address_1, address_2: @midpoint.address_2, midpoint: @midpoint.midpoint }
    end
  ...
  test "should update midpoint" do
    patch :update, id: @midpoint, midpoint: { address_1: @midpoint.address_1, address_2: @midpoint.address_2, midpoint: @midpoint.midpoint }
    assert_redirected_to midpoint_path(assigns(:midpoint))
  end
